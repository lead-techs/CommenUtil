...
{      
    ...
    public MessageProcessor(int organizationId, int repositoryId, int sourceApplicationId,String messageType,String datasourceConnectionName,List<String> skipedMessageNames,int clientNodeId)
    {
    ...
    { 
        ...
        try
        {
            ...
            if ( currentMessageType.equals(messageType) )
            {
                ...
                while( j>=0 )
                {
                    ...
                    try
                    {
                        log.info(" No="+kk+", childMessage = "+childMessage.substring(0, 100)+" ...");
                    }
                    catch(Exception e)
                    {
        ...
        {
            errorInfo = " process failed! e="+e+",childMessage="+childMessage+", stacktrace="+ExceptionUtils.getStackTrace(e);
            log.error(errorInfo);
