...
{    
        ...
        while(retry >0 )
        {
            ...
            try
            {
                ...
                if ( ieRep.isExists() == false )
                    ESUtil1.createIndexWithoutType(esClient, indexName);
    ...
    public static JSONObject getDocument(Client esClient,int organizationId, String dataobjectId, String indexType)
    {
        ...
        Map<String,Object> ret = ESUtil1.searchDocument(esClient, new String[]{}, indexTypes, new String[]{}, queryStr, null, 1,0, new String[]{}, new String[]{});
    ...
    public static long indexDocument(Client client, String indexName, String indexTypeName, String docId, Map<String,Object> jsonMap) throws Exception
    {
        ...
        if ( ieRep.isExists() == false )
        {
            ...
            ESUtil1.createIndexWithoutType(client, indexName);    

            Tool.SleepAWhile(1, 0); // sleep 3 second

            for(int i=0;i<3;i++)
            {
                ESUtil1.addIndexToAlias(client, indexSetName, indexName, "add");
                Tool.SleepAWhile(1, 0); // sleep 3 second
            }
        }
        ...
        try
        {
            ...
            {                
                ...
                if ( dataTypeStr.equals("string") )
                {
                    ...
                    //if ( indexTypeStr.equals("not_analyzed"))
                    //    mapping.startObject(nameStr).field("type","keyword").field("store", true).field("index",true).field("boost",boostVal).endObject();
                    //else // both or analyzed
